                    ...
                    <div class="tab-pane fade  <?php echo !isset($_POST['update-password']) ? '' : 'active show'; ?>" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <span class="edit-error"><?php echo form_error('account'); ?></span>
                                <hr>
                                <form method="POST">
                                    <div class="mb-3">
                                    ...
                                    <span class="edit-error"><?php echo form_error('newPassword'); ?></span>
                                    ...
                                    <span class="edit-error"><?php echo form_error('oldPassword'); ?></span>
