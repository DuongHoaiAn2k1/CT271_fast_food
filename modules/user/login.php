            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  <p class="text-center" style="display: <?php echo isset($_GET['i']) ? 'block' : 'none' ?>; color: red;">Bạn vui lòng đăng nhập để có thể thanh toán!!!</p>
                  ...
                  <form method="POST" class="mx-1 mx-md-4">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4" style="margin-left: 8%;">
                      <label class="form-label" for="form3Example4cd">
                        ...
                        <a href="?mod=user&act=register">Đăng ký</a></label>
                    </div>
