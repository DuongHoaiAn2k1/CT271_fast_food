                            ...
                            <div class="row g-0">
                                <div class="col-lg-8">
                                    <div class="p-5">
                                        ...
                                        ?>
                                                ...
                                                <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                                        ...
                                                        <input id="form1" name="quantity" value="<?php echo $item['qty'] ?>" type="number" class="form-control form-control-sm quantity" style="width: 40px" min="1" max="9" value="1" data-id="<?php echo $item['product_id'] ?>" />
                                        ...
                                        ?>
                                        <div class="pt-5">
                                            <h6 class="mb-0"><a href="?mod=product" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Tiếp tục mua hàng</a></h6>
                                        </div>
                                    </div>
                                </div>
