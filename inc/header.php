...
<head>
  ...
  <title>Trang Web Responsive</title>
  <style>
    .sidebar {
      height: 100%;
      width: 0;
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container-fluid">
        ...
        <div class="d-flex align-items-center" style="font-size: 22px;">
          <!-- Icon -->
          <a class="text-reset me-4" href="?mod=cart">
          ...
          <!-- Avatar -->
          <div class="ms-2 me-2">
            <a class=" d-flex align-items-center hidden-arrow" href="<?php echo empty($_SESSION['is_login']) ? '?mod=user&act=login' : '?mod=user&act=account';
